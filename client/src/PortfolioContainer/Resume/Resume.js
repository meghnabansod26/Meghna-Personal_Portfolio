...
const Resume = (props) => {
  ...
  const achievementsDetails = [
    ...
    // },
  
     {
      ...
      duration: { fromDate: "Jan-24", toDate: "Jun-24" },

      subHeading: "Certificate of Java Backend Development",
    },
      {
      title: "Udemy",
      duration: { fromDate: "Sep-23 ", toDate: "Oct-23" },

      subHeading: "Certificate of Full Stack Web Development Bootcamp",
    },
     {
      title: "HackerRank ",
    ...
    <div className="resume-screen-container" key="work-experience" >
      <div className="experience-container">
        <ResumeHeading
          ...
          subHeading={"Lentra AI"}
          fromDate={"Oct-24"}
          toDate={"Present"}
        />
        <div className="experience-description">
          <span className="resume-description-text">
            - Building full-stack features using Angular, Java, and Spring Boot.
          </span>
          <br />
          <span className="resume-description-text">
            - Worked on projects like IndusInd LAP, Bandhan PL, HDFC KCC, and
            MultiBureau.
          </span>
          <br />
          <span className="resume-description-text">
            - Collaborating in Agile teams on real-world banking solutions.
          </span>
        </div>
        <br></br>
  ...
  const getBullets = () => {
    return resumeBullets.map((bullet, index) => (
      ...
      >
        <img
          className="bullet-logo" alt="bullet-logo"
